...
The system SHALL compute a deterministic batch idempotency key for each generation request:
`SHA256(StoryboardVersionId + ":" + AssetRequirementId + ":" + CandidateCount + ":" + GenerationRevision + ":" + ConfigurationFingerprint)`
