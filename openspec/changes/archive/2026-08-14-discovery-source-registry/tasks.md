...
- [x] 6.2 Perform end-to-end human verification flow: register source, trigger sync, submit manual URL and text lead via Quick Submit, preview in drawer, triage candidate, verify dashboard counters
